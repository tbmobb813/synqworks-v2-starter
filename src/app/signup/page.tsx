    ...
    return (
      <div className="min-h-screen bg-zinc-50 flex items-center justify-center px-6">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-2xl font-black text-zinc-900 tracking-tight mb-3">Check your email</h1>
          <p className="text-sm font-mono text-zinc-500">
            We sent a confirmation link to <span className="text-zinc-900">{email}</span>.
            Click it to activate your account.
          </p>
          <Link href="/login" className="inline-block mt-6 text-xs font-mono text-emerald-600 hover:underline">
            Back to sign in
          </Link>
        </div>
      </div>
